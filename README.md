...
[![image](https://github.com/dkpro/dkpro-cassis/actions/workflows/run_tests.yml/badge.svg)](https://github.com/dkpro/dkpro-cassis/actions/workflows/run_tests.yml)

[![Documentation Status](https://readthedocs.org/projects/cassis/badge/?version=latest)](https://cassis.readthedocs.io/en/latest/?badge=latest)

[![image](https://codecov.io/gh/dkpro/dkpro-cassis/branch/main/graph/badge.svg)](https://codecov.io/gh/dkpro/dkpro-cassis)

[![PyPI - License](https://img.shields.io/pypi/l/dkpro-cassis.svg)](https://pypi.org/project/dkpro-cassis/)

[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/dkpro-cassis.svg)](https://pypi.org/project/dkpro-cassis/)

[![PyPI](https://img.shields.io/pypi/v/dkpro-cassis.svg)](https://pypi.org/project/dkpro-cassis/)
...
as defined by the [UIMA](https://uima.apache.org) framework. The CAS is a data structure representing an object to
...
or the [CAS JSON representation](https://github.com/apache/uima-uimaj-io-jsoncas#readme) in Python programs. This can ease in particular the integration of Python-based Natural Language Processing (e.g.
[spacy](https://spacy.io) or [NLTK](https://www.nltk.org)) and Machine Learning librarys (e.g.
[scikit-learn](https://scikit-learn.org/stable/) or [Keras](https://keras.io)) in UIMA-based text analysis workflows.
...
e.g. a feature structure with feature `a` that has a
feature `b` that has a feature `c`, some of which can be `None`, then you can use the
following:
...
If `a` or `b` or `c` are `None`, then this returns instead of
throwing an error.
...
achieved via the `merge_typesystems` function. The detailed rules of merging can be found
[here](https://uima.apache.org/d/uimaj-current/ref.html#ugr.ref.cas.typemerging).
...
If your type system defines a type called `self` or `type`, then it will be made
...
then you can disable this security check by passing `trusted=True` to your calls to `load_cas_from_xmi`.
...
Common development tasks are exposed via [taskipy](https://github.com/taskipy/taskipy):
